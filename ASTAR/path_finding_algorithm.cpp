...
int closedNodes[IDIM][JDIM];// list of closed (check-out) nodes
int openNodes[IDIM][JDIM];// list of open (not-yet-checked-out) nodes
int dirMap[IDIM][JDIM];// map of directions (0: East, 1: North, 2: West, 3: South) 
