\hypertarget{eda_8hpp}{
\section{eda.hpp File Reference}
\label{eda_8hpp}\index{eda.hpp@{eda.hpp}}
}
Header file for \hyperlink{eda_8cpp}{eda.cpp}. 
...
\begin{CompactList}\small\item\em Parameters for the decision-tree EDA (can be set using parameter files). \item\end{CompactList}\end{CompactItemize}
\subsection*{Functions}
\begin{CompactItemize}
\item 
int \hyperlink{eda_8hpp_9b0a6b9ef45625cf62beee0698f29c38}{generate\_\-population} (int $\ast$$\ast$x, int n, int N)
\item 
int $\ast$$\ast$ \hyperlink{eda_8hpp_bad30812456a4a71d90a3612cd9793f7}{allocate\_\-population} (int n, int N)
\begin{CompactList}\small\item\em Allocate memory for a new population of specified parameters. \item\end{CompactList}\item 
void \hyperlink{eda_8hpp_a9eb525500760458e6348fa016194a73}{free\_\-population} (int $\ast$$\ast$x, int n, int N)
\begin{CompactList}\small\item\em Free memory occupied by a population of specified parameters. \item\end{CompactList}\item 
int \hyperlink{eda_8hpp_fbba716ba914b45a09d2ebe73d592e75}{evaluate\_\-population} (int $\ast$$\ast$x, double $\ast$f, int n, int N)
\item 
int \hyperlink{eda_8hpp_b7834469dba3fdd4d1e73b368051dbae}{tournament\_\-selection} (int $\ast$$\ast$y, int $\ast$$\ast$x, double $\ast$f, int n, int N, int k)
\begin{CompactList}\small\item\em Tournament selection with replacement (k-ary tournaments). \item\end{CompactList}\item 
void \hyperlink{eda_8hpp_aea6e51089cae913316f55a552b9226c}{print\_\-population} (FILE $\ast$f, int $\ast$$\ast$x, int n, int N)
\begin{CompactList}\small\item\em Print the population to the specified file. \item\end{CompactList}\item 
int \hyperlink{eda_8hpp_1d4a4cf7ab331605bd8baf7e88c4dd14}{restricted\_\-tournament\_\-replacement} (int $\ast$$\ast$y, int $\ast$$\ast$x, int n, int N, double $\ast$fx, double $\ast$fy)
\begin{CompactList}\small\item\em Restricted tournament replacement (Harik, 1995) for niching. \item\end{CompactList}\item 
int \hyperlink{eda_8hpp_396cf5fd61462fac3746b312f12c5c69}{full\_\-replacement} (int $\ast$$\ast$y, int $\ast$$\ast$x, int n, int N, double $\ast$fx, double $\ast$fy)
\begin{CompactList}\small\item\em Replace the entire old population with the new population. \item\end{CompactList}\item 
int \hyperlink{eda_8hpp_1329a1829493fea528b0e690ab69f94e}{individual\_\-distance} (int $\ast$x, int $\ast$y, int n)
...
int \hyperlink{eda_8hpp_8eef87c9ae12bcae144b6b020865df42}{variation} (int $\ast$$\ast$sampled\_\-population, int $\ast$$\ast$selected\_\-population, \hyperlink{struct_parameters}{Parameters} $\ast$params, int $\ast$num\_\-vals)
...
void \hyperlink{eda_8hpp_be5265230638c7fb37140688226999e2}{print\_\-status} (int t, \hyperlink{struct_population_statistics}{Population\-Statistics} $\ast$stats)
\begin{CompactList}\small\item\em Print the status of the algorithm. \item\end{CompactList}\item 
void \hyperlink{eda_8hpp_83b5f930be040dac41889ae6d326a47a}{print\_\-summary} (\hyperlink{struct_population_statistics}{Population\-Statistics} $\ast$stats)
\begin{CompactList}\small\item\em Print summary of a run. \item\end{CompactList}\item 
int \hyperlink{eda_8hpp_334f5d73c2118df22dd59546965be64c}{one\_\-run} (\hyperlink{struct_parameters}{Parameters} $\ast$params, \hyperlink{struct_population_statistics}{Population\-Statistics} $\ast$stats)
...
int \hyperlink{eda_8hpp_6691772a0d2ac34de31e1daf06e33343}{generate\_\-BB\_\-population} (int $\ast$$\ast$x, int n, int N, int k)
...
void \hyperlink{eda_8hpp_bc382593d84d02abc91d4201dd91b806}{separator} (FILE $\ast$f, int type=1)
\begin{CompactList}\small\item\em Print a sequence of dashes to separate text output. \item\end{CompactList}\end{CompactItemize}
...
Definition in file \hyperlink{eda_8hpp-source}{eda.hpp}.

\subsection{Function Documentation}
\hypertarget{eda_8hpp_bad30812456a4a71d90a3612cd9793f7}{
\index{eda.hpp@{eda.hpp}!allocate_population@{allocate\_\-population}}
\index{allocate_population@{allocate\_\-population}!eda.hpp@{eda.hpp}}
\subsubsection[allocate\_\-population]{\setlength{\rightskip}{0pt plus 5cm}int$\ast$$\ast$ allocate\_\-population (int {\em n}, int {\em N})}}
\label{eda_8hpp_bad30812456a4a71d90a3612cd9793f7}
...
\hypertarget{eda_8hpp_fbba716ba914b45a09d2ebe73d592e75}{
\index{eda.hpp@{eda.hpp}!evaluate_population@{evaluate\_\-population}}
\index{evaluate_population@{evaluate\_\-population}!eda.hpp@{eda.hpp}}
\subsubsection[evaluate\_\-population]{\setlength{\rightskip}{0pt plus 5cm}int evaluate\_\-population (int $\ast$$\ast$ {\em x}, double $\ast$ {\em f}, int {\em n}, int {\em N})}}
\label{eda_8hpp_fbba716ba914b45a09d2ebe73d592e75}


\hypertarget{eda_8hpp_a9eb525500760458e6348fa016194a73}{
\index{eda.hpp@{eda.hpp}!free_population@{free\_\-population}}
\index{free_population@{free\_\-population}!eda.hpp@{eda.hpp}}
...
\label{eda_8hpp_a9eb525500760458e6348fa016194a73}
...
\hypertarget{eda_8hpp_396cf5fd61462fac3746b312f12c5c69}{
\index{eda.hpp@{eda.hpp}!full_replacement@{full\_\-replacement}}
\index{full_replacement@{full\_\-replacement}!eda.hpp@{eda.hpp}}
\subsubsection[full\_\-replacement]{\setlength{\rightskip}{0pt plus 5cm}int full\_\-replacement (int $\ast$$\ast$ {\em y}, int $\ast$$\ast$ {\em x}, int {\em n}, int {\em N}, double $\ast$ {\em fx}, double $\ast$ {\em fy})}}
\label{eda_8hpp_396cf5fd61462fac3746b312f12c5c69}
...
\hypertarget{eda_8hpp_6691772a0d2ac34de31e1daf06e33343}{
\index{eda.hpp@{eda.hpp}!generate_BB_population@{generate\_\-BB\_\-population}}
\index{generate_BB_population@{generate\_\-BB\_\-population}!eda.hpp@{eda.hpp}}
...
\label{eda_8hpp_6691772a0d2ac34de31e1daf06e33343}
...
\hypertarget{eda_8hpp_9b0a6b9ef45625cf62beee0698f29c38}{
\index{eda.hpp@{eda.hpp}!generate_population@{generate\_\-population}}
\index{generate_population@{generate\_\-population}!eda.hpp@{eda.hpp}}
\subsubsection[generate\_\-population]{\setlength{\rightskip}{0pt plus 5cm}int generate\_\-population (int $\ast$$\ast$ {\em x}, int {\em n}, int {\em N})}}
\label{eda_8hpp_9b0a6b9ef45625cf62beee0698f29c38}


\hypertarget{eda_8hpp_1329a1829493fea528b0e690ab69f94e}{
\index{eda.hpp@{eda.hpp}!individual_distance@{individual\_\-distance}}
\index{individual_distance@{individual\_\-distance}!eda.hpp@{eda.hpp}}
...
\label{eda_8hpp_1329a1829493fea528b0e690ab69f94e}
...
\hypertarget{eda_8hpp_334f5d73c2118df22dd59546965be64c}{
\index{eda.hpp@{eda.hpp}!one_run@{one\_\-run}}
\index{one_run@{one\_\-run}!eda.hpp@{eda.hpp}}
...
\label{eda_8hpp_334f5d73c2118df22dd59546965be64c}
...
\hypertarget{eda_8hpp_aea6e51089cae913316f55a552b9226c}{
\index{eda.hpp@{eda.hpp}!print_population@{print\_\-population}}
\index{print_population@{print\_\-population}!eda.hpp@{eda.hpp}}
...
\label{eda_8hpp_aea6e51089cae913316f55a552b9226c}
...
\hypertarget{eda_8hpp_be5265230638c7fb37140688226999e2}{
\index{eda.hpp@{eda.hpp}!print_status@{print\_\-status}}
\index{print_status@{print\_\-status}!eda.hpp@{eda.hpp}}
...
\label{eda_8hpp_be5265230638c7fb37140688226999e2}
...
\hypertarget{eda_8hpp_83b5f930be040dac41889ae6d326a47a}{
\index{eda.hpp@{eda.hpp}!print_summary@{print\_\-summary}}
\index{print_summary@{print\_\-summary}!eda.hpp@{eda.hpp}}
...
\label{eda_8hpp_83b5f930be040dac41889ae6d326a47a}
...
\hypertarget{eda_8hpp_1d4a4cf7ab331605bd8baf7e88c4dd14}{
\index{eda.hpp@{eda.hpp}!restricted_tournament_replacement@{restricted\_\-tournament\_\-replacement}}
\index{restricted_tournament_replacement@{restricted\_\-tournament\_\-replacement}!eda.hpp@{eda.hpp}}
\subsubsection[restricted\_\-tournament\_\-replacement]{\setlength{\rightskip}{0pt plus 5cm}int restricted\_\-tournament\_\-replacement (int $\ast$$\ast$ {\em y}, int $\ast$$\ast$ {\em x}, int {\em n}, int {\em N}, double $\ast$ {\em fx}, double $\ast$ {\em fy})}}
\label{eda_8hpp_1d4a4cf7ab331605bd8baf7e88c4dd14}
...
\hypertarget{eda_8hpp_bc382593d84d02abc91d4201dd91b806}{
\index{eda.hpp@{eda.hpp}!separator@{separator}}
\index{separator@{separator}!eda.hpp@{eda.hpp}}
\subsubsection[separator]{\setlength{\rightskip}{0pt plus 5cm}void separator (FILE $\ast$ {\em f}, int {\em type} = {\tt 1})}}
\label{eda_8hpp_bc382593d84d02abc91d4201dd91b806}
...
\hypertarget{eda_8hpp_b7834469dba3fdd4d1e73b368051dbae}{
\index{eda.hpp@{eda.hpp}!tournament_selection@{tournament\_\-selection}}
\index{tournament_selection@{tournament\_\-selection}!eda.hpp@{eda.hpp}}
...
\label{eda_8hpp_b7834469dba3fdd4d1e73b368051dbae}
...
\hypertarget{eda_8hpp_8eef87c9ae12bcae144b6b020865df42}{
\index{eda.hpp@{eda.hpp}!variation@{variation}}
\index{variation@{variation}!eda.hpp@{eda.hpp}}
...
\label{eda_8hpp_8eef87c9ae12bcae144b6b020865df42}
